...
module.exports = {
    ...
    dot: dot,
    cross: cross,
    getNormalofThreePoints: getNormalofThreePoints,
    scaleVector: scaleVector,
    vectorFromTo: vectorFromTo,
    addVectors: addVectors,
    getUnitVector: getUnitVector,
    projectedVectorOntoPlane: projectedVectorOntoPlane,
    vectorLength: vectorLength,
    angleBetween: angleBetween,
    angleOppositeOfLastSide: angleOppositeOfLastSide,
    isCounterClockwise: isCounterClockwise,
    tRotXmatrix: tRotXmatrix,
    tRotYmatrix: tRotYmatrix,
    tRotZmatrix: tRotZmatrix,
    tRotXYZmatrix: tRotXYZmatrix,
    skew: skew,
    matrixToAlignVectorAtoB: matrixToAlignVectorAtoB,
    multiply4x4: multiply4x4
}
