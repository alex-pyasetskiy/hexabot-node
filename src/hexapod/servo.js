const { DEFAULT_SERVO_POSE_VALUE } = require("../configs");
...
function controllerCMD({
    ...
    const servos = {
        21: translatePose(
            leftFront.alpha,
            DEFAULT_SERVO_POSE_VALUE.leftFront.alpha,
            false
        ),
        22: translatePose(leftFront.beta, DEFAULT_SERVO_POSE_VALUE.leftFront.beta, true),
        23: translatePose(
            leftFront.gamma,
            DEFAULT_SERVO_POSE_VALUE.leftFront.gamma,
            false
        ),

        25: translatePose(
            leftMiddle.alpha,
            DEFAULT_SERVO_POSE_VALUE.leftMiddle.alpha,
            false
        ),
        26: translatePose(
            leftMiddle.beta,
            DEFAULT_SERVO_POSE_VALUE.leftMiddle.beta,
            true
        ),
        27: translatePose(
            leftMiddle.gamma,
            DEFAULT_SERVO_POSE_VALUE.leftMiddle.gamma,
            false
        ),
        ...
        1: translatePose(
            rightBack.alpha,
            DEFAULT_SERVO_POSE_VALUE.rightBack.alpha,
            false
        ),
        ...
        6: translatePose(
            rightMiddle.alpha,
            DEFAULT_SERVO_POSE_VALUE.rightMiddle.alpha,
            false
        ),
        7: translatePose(
            rightMiddle.beta,
            DEFAULT_SERVO_POSE_VALUE.rightMiddle.beta,
            false
        ),
        8: translatePose(
            rightMiddle.gamma,
            DEFAULT_SERVO_POSE_VALUE.rightMiddle.gamma,
            true
        ),

        10: translatePose(
            rightFront.alpha,
            DEFAULT_SERVO_POSE_VALUE.rightFront.alpha,
            false
        ),
        11: translatePose(
            rightFront.beta,
            DEFAULT_SERVO_POSE_VALUE.rightFront.beta,
            false
        ),
        12: translatePose(
            rightFront.gamma,
            DEFAULT_SERVO_POSE_VALUE.rightFront.gamma,
            true
        ),
    }
...
module.exports.controllerCMD = controllerCMD;
module.exports.translatePose = translatePose;