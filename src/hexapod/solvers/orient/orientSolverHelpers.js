const { dot, cross, vectorFromTo } = require("../../geometry");
...
module.exports = {
    SOME_LEG_ID_TRIOS: SOME_LEG_ID_TRIOS,
    ADJACENT_LEG_ID_TRIOS: ADJACENT_LEG_ID_TRIOS,
    isStable: isStable,
    isLower: isLower,
    findLegsOnGround: findLegsOnGround
}
