...
Joystick.create("/dev/input/by-id/usb-Logitech_Logitech_Cordless_RumblePad_2-joystick", function (err, joystick) {
  if (err) {
    throw err;
  }
  ...
  joystick.on("button:lt:press", function (position) {
    console.log("Button LT pressed" + position);
  });

  joystick.on("button:lt:release", function (position) {
    console.log("Button LT released" + position);
  });

  // Button RT

  joystick.on("button:rt:press", function (position) {
    console.log("Button RT pressed" + position);
  });

  joystick.on("button:rt:release", function (position) {
    console.log("Button RT released" + position);
  });
